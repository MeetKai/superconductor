...
pub use renderer_core::{assets::textures, glam::Vec3};
...
struct MainBindGroup(Arc<parking_lot::Mutex<wgpu::BindGroup>>);
    ...
    fn build(&self, app: &mut App) {
        ...
        app.add_stage(
            ...
            SystemStage::single_threaded()
                ...
                .with_system(systems::clear_instance_buffer)
                .with_system(systems::push_entity_instances)
                .with_system(systems::upload_instances)
                .with_system(systems::rendering::render),
        );
